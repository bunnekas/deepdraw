...
from data.dataloader import get_loader, load_categories
import logging
...
def main():
    ...
    # set wandb run name
    wandb.run.name = 'DinoV2_finetuned_epoch_3'
    ...
    config = {
        ...
        'batch_size': 64,
        'num_workers': 4,
        'checkpoint_path': '/home/lect0149/gitlab/outputs/checkpoints_/checkpoint_epoch_3.pt',
